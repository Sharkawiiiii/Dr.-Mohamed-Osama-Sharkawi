...
import { Globe, Users, BookOpen, Mic, MapPin } from "lucide-react";

const teachingStats = [
    { value: "10+", label: "Years Teaching", icon: BookOpen },
    { value: "100+", label: "Courses Delivered", icon: Mic },
    { value: "2000+", label: "Professionals Trained", icon: Users },
];

const highlights = [
    {
        title: "Acupuncture for MSK Conditions",
        description:
            "Comprehensive course covering evidence-based acupuncture protocols for musculoskeletal disorders",
        type: "Course Creator",
    },
    {
        title: "International Workshops",
        description:
            "Delivered training workshops across Egypt, UK, and internationally for physiotherapists and doctors",
        type: "Workshop Leader",
    },
    {
        title: "Conference Speaker",
        description:
            "Regular speaker at national and international physiotherapy and acupuncture conferences",
        type: "Speaker",
    },
];

const internationalLocations = [
    { name: "Egypt", flag: "🇪🇬", role: "Base of Operations" },
    { name: "United Kingdom", flag: "🇬🇧", role: "PRIMEPHYSIO Instructor" },
    { name: "China", flag: "🇨🇳", role: "CACMS Training" },
];
            ...
            <div className="container relative">
                ...
                >
                    ...
                    <h2 className="text-3xl md:text-4xl lg:text-5xl font-bold mt-2 mb-4">
                        Teaching & <span className="gradient-text">Training</span>
                    </h2>
                    <p className="text-gray-500 max-w-2xl mx-auto">
                        Dedicated to advancing professional education in acupuncture and
                        physiotherapy across multiple countries
                    </p>
                </motion.div>
                ...
                >
                    <div className="flex items-center justify-center gap-2 mb-8">
                        ...
                        <h3 className="text-2xl font-bold">International Presence</h3>
                    </div>
                    ...
                    <div className="grid md:grid-cols-3 gap-6">
                        {highlights.map((highlight, index) => (
                            <motion.div
                                ...
                                transition={{ delay: index * 0.15, duration: 0.5 }}
                                whileHover={{ y: -5 }}
                                className="card p-6 border-t-4 border-teal-500"
                            >
                                <span className="inline-block px-3 py-1 bg-teal-50 text-teal-700 text-xs font-medium rounded-full mb-4">
                                    {highlight.type}
                                </span>
